### Use Case Scenario
## Sample Use Case - HR Analytics

# Loading Datasets - Glassdoor Reviews
...
### Step 3 - Text Organization - Cleaning
library(qdap)
library(tm)

# Creating QDAP Function
...
tm_clean <- function(corpus) {
  ...
  corpus <- tm_map(corpus, removeWords, c(stopwords("en"), "Amazon", "Google", "company"))
  return(corpus)
}
...
### Featuring Extracting & Analysing - Sentiment Scoring Purpose!!
...
# Printing amzn_c_tdm2 to the console
amzn_c_tdm2
